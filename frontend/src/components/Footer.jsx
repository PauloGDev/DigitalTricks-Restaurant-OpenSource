...
const WHATSAPP_URL = "https://wa.me/5585984642900";
const INSTAGRAM_URL = "https://www.instagram.com/digitaltricks";
...
const Footer = () => {
  ...
  const perfil = useMemo(() => {
    ...
    return isAdmin ? PERFIL.ADMIN : PERFIL.CLIENTE;
  }, [user?.roles, !!user]);

  const isRestaurante = location.pathname.startsWith("/restaurante/");
    ...
    if (perfil === PERFIL.CLIENTE) {
      return {
        ...
        links: [
          ...
          { label: "Suporte", path: WHATSAPP_URL, external: true },
        ],
      };
    }
  ...
  return (
    <footer className="w-full z-10 bg-zinc-950 text-white/80 relative border-t border-white/10">
      ...
      {isRestaurante && qtdItensCarrinho > 0 && (
